...
BOT_TOKEN = os.getenv('BOT_TOKEN','8301187521:AAWn_J0FYI')
CHAT_IDS = ['-1002591228761',]
USERNAME = os.getenv('PANEL_USERNAME', 'LordAizen')
PASSWORD = os.getenv('PANEL_PASSWORD', 'LordAizen')
    ...
    for row in data['aaData']:
        try:
            ...
            keyboard = InlineKeyboardMarkup([
                [InlineKeyboardButton("🔍 SUPPORT GROUP", url="https://t.me/agenthope69")],
                [InlineKeyboardButton("☎️ NUMBER CHANNEL", url="https://t.me/freefireturgroup")]
            ])
